...
class SupabaseConfig {
  static final SupabaseClient supabase = SupabaseClient(
    ...
    'https://lcobvndzdtpgdwywjtxb.supabase.co', // Replace with your Supabase URL
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxjb2J2bmR6ZHRwZ2R3eXdqdHhiIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDMyMTE2OTUsImV4cCI6MjA1ODc4NzY5NX0.eosLwIg_fB2HsPFiFPZ4VPQur2ZOdrxuhDTPOr_8hTs', // Replace with your Supabase anon key
  );
